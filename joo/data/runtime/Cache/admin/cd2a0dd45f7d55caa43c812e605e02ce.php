...
<!--接口列表-->
<div class="pad_10">
    <div class="J_tablelist table_list" data-acturi="<?php echo U('oauth/ajax_edit');?>">
        <table width="100%" cellspacing="0">
            <thead>
            <tr>
                <th width="40"><input type="checkbox" name="checkall" class="J_checkall"></th>
      			<th><?php echo L('oauth_code');?></th>
                <th><?php echo L('oauth_name');?></th>
                <th><span data-tdtype="order_by" data-field="ordid"><?php echo L('sort_order');?></span></th>
                <th><?php echo L('enabled');?></th>
                <th><?php echo L('oauth_desc');?></th>
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i; if($val["status"] > -1): ?><tr>
                ...
                <td align="center">
                    <a href="javascript:;" class="J_showdialog" data-uri="<?php echo U('oauth/edit', array('id'=>$val['id']));?>" data-title="<?php echo L('edit');?> - <?php echo ($val["name"]); ?>"  data-id="edit"><?php echo L('edit');?></a> | 
                    <a href="javascript:;" class="J_confirmurl" data-acttype="ajax" data-uri="<?php echo U('oauth/delete', array('id'=>$val['id']));?>" data-msg="<?php echo sprintf(L('confirm_uninstall_one'),$val['name']);?>"><?php echo L('uninstall');?></a>
                </td>
            </tr>
            <?php else: ?>
            <tr>
                ...
                <td align="center"><?php echo ($val["author"]); ?></td>
                <td align="center">
                    <a href="javascript:;" class="J_showdialog" data-uri="<?php echo U('oauth/install', array('code'=>$val['code']));?>" data-title="<?php echo L('install');?> - <?php echo ($val["name"]); ?>" data-id="install"><?php echo L('install');?></a>
                </td>
    ...
    <div class="btn_wrap_fixed">
        ...
        <input type="button" class="btn" data-tdtype="batch_action" data-acttype="ajax" data-uri="<?php echo U('oauth/delete');?>" data-name="id" data-msg="<?php echo L('confirm_uninstall');?>" value="<?php echo L('uninstall');?>" />
