...
<div class="pad_lr_10" >
    ...
    <div class="J_tablelist table_list" data-acturi="<?php echo U('message_tpl/ajax_edit');?>">
    <table width="100%" cellspacing="0">
    	...
    	<tbody>
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                <td align="center">
                <?php if($val['is_sys'] == 1): else: ?>
                <input type="checkbox" class="J_checkitem" value="<?php echo ($val["id"]); ?>"><?php endif; ?>
                </td>
                ...
                <td align="center">
                <a href="<?php echo u('message_tpl/edit', array('id'=>$val['id'], 'menuid'=>$menuid));?>" >编辑</a> <?php if($val['is_sys'] == 1): else: ?>| <a href="javascript:void(0);" class="J_confirmurl" data-uri="<?php echo u('message_tpl/delete', array('id'=>$val['id']));?>" data-acttype="ajax" data-msg="<?php echo sprintf(L('confirm_delete_one'),$val['username']);?>"><?php echo L('delete');?></a><?php endif; ?></td>
    ...
    <div class="btn_wrap_fixed">
        ...
        <input type="button" class="btn" data-tdtype="batch_action" data-acttype="ajax" data-uri="<?php echo U('message_tpl/delete');?>" data-name="id" data-msg="<?php echo L('confirm_delete');?>" value="<?php echo L('delete');?>" />
