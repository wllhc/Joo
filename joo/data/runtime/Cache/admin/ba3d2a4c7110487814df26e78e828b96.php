...
<div class="pad_10">
	...
	<div class="clearfix">
        <div class="col-2">
            <h6>PinPHP动态</h6>
            <div class="content">
                <iframe src="http://www.pinphp.com/pin.php" style="width:100%;height:100px;" frameborder="0">
                </iframe>
            </div>
        </div>
        ...
        <div class="col-2 mt10">
            ...
            <div class="content">
                <table class="table_panel lh26" style="width: 100%;">
                    ...
                    <tr>
                        <td>产品研发：</td>
                        <td>李长勇(andery)、李苏亮(solaa)、胡怀行(湖水清)、王世豪(brivio)</td>
                    </tr>
                    <tr>
                        <td>UED：</td>
                        <td>陈勇(Mr)、李长勇(andery)</td>
                    </tr>
                    <tr>
                        <td>市场运营：</td>
                        <td>许华平(jonyxu)</td>
