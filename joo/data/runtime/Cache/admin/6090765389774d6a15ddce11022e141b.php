        ...
        <tbody>
            <tr>
                ...
                <div class="explain_col">
					...
					&nbsp;&nbsp;佣金比率 :
					<input type="text" name="rates_min" class="input-text" size="5" value="<?php echo ($search["rates_min"]); ?>" />
                     - 
                    <input type="text" name="rates_max" class="input-text" size="5" value="<?php echo ($search["rates_max"]); ?>" />
    ...
    <table width="100%" cellspacing="0">
        <thead>
            <tr>
				...
				<th width="70"><span data-tdtype="order_by" data-field="rates">佣金比率</span></th>
                <th width="40"><span data-tdtype="order_by" data-field="likes">喜欢</span></th>
                <th width="40"><span data-tdtype="order_by" data-field="hits">人气</span></th>
    	...
    	<tbody>
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
				...
				<td align="center" class="red"><?php echo ($val["rates"]); ?>%</td> 
                <td align="center"><span data-tdtype="edit" data-field="likes" data-id="<?php echo ($val["id"]); ?>" class="tdedit"><?php echo ($val["likes"]); ?></span></td>
                <td align="center"><span data-tdtype="edit" data-field="hits" data-id="<?php echo ($val["id"]); ?>" class="tdedit"><?php echo ($val["hits"]); ?></span></td>
