    	...
    	<div class="indexcont">
            <div class="ibottompart">
                <div class="cbar clearfix">
                    <?php if($cur_sort == 'hot'): ?><a href="<?php echo U('book/index', array('sort'=>'hot'));?>" class="current">最热</a>
                    <a href="<?php echo U('book/index', array('sort'=>'new'));?>">最新</a>
                    <?php else: ?>
                    <a href="<?php echo U('book/index', array('sort'=>'hot'));?>">最热</a>
                    <!--a href="javascript:" onClick="gIndex.find('new');">最新</a-->
                    <a href="<?php echo U('book/index', array('sort'=>'new'));?>" class="current">最新</a><?php endif; ?>
                    <div class="picsort">
                        <select class="infoselect">
                            <?php if(is_array($hot_tags)): $i = 0; $__LIST__ = $hot_tags;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tag): $mod = ($i % 2 );++$i;?><option value="<?php echo U('book/index',array('tag'=>$tag));?>"><?php echo ($tag); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                   	</select>
                	<span></span>
                </div>
                </div>
