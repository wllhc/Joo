        ...
        <div class="cbar clearfix">
            ...
            <div class="piccont clearfix">
                <div id="follow" style="display:">
                    <div class="follow">
                        <?php if(is_array($user_list)): $i = 0; $__LIST__ = $user_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><div class="followcard">
                            <div class="follow_avatar">
                                <a href="<?php echo U('space/index', array('uid'=>$val['id']));?>"><img class="J_card fl r5" src="<?php echo avatar($val['id'], 48);?>" data-uid="<?php echo ($val["id"]); ?>" width="100" height="100" /></a>
                            </div>
                            <div class="follow_info">
                                <h2><a href="<?php echo U('space/index', array('uid'=>$val['id']));?>"><?php echo ($val["username"]); ?></a></h2>
                                <p>
                                <?php if($visitor['id'] == $user['id']): ?><!--自己访问-->
                                    <?php if($val['mutually'] == 0): ?><a href="javascript:;" class="J_unfo_u green"><span class="fo_u_ok"><?php echo L('followed');?> | </span><?php echo L('cancel');?></a>
                                    <?php else: ?>
                                        <a href="javascript:;" class="J_unfo_u green"><span class="fo_u_all"><?php echo L('follow_mutually');?> | </span><?php echo L('cancel');?></a><?php endif; ?>
                                <?php else: ?>
                                    <!--查看别人-->
                                    <a href="javascript:;" class="J_fo_u fo_u_btn"><?php echo L('follow');?></a><?php endif; ?>
                                </p>
