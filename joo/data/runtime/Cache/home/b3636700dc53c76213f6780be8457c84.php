...
<div class="content">
    ...
    <dl>
        ...
        <div class="set_content">
            <div>
                <div class="settitle clearfix"><h3><?php echo L('edit_password');?></h3><span></span></div>
                <div class="arrwhite">
                    <?php if(isset($msg)): ?><div class="<?php if($msg["status"] == 1): ?>green_alert<?php else: ?>pink_alert<?php endif; ?>"><?php echo ($msg["info"]); ?></div><?php endif; ?>
                </div>
                <div class="cardcontent">
                    <div class="myinfo">
                        <div class="myavartar clearfix">

                            <form id="J_password_form" action="<?php echo U('user/password');?>" method="post">
                                <div class="setbox mail">
                                    <h2><?php echo L('old_password');?>：</h2>
                                    <p><input name="oldpassword" class="gray_text" type="password"></p>
                                </div>
                                <div class="setbox mail">
                                    <h2><?php echo L('new_password');?>：</h2>
                                    <p><input name="password" id="J_password" class="gray_text" type="password"></p>
                                </div>
                                <div class="setbox mail">
                                    <h2><?php echo L('confirm_new_password');?>：</h2>
                                    <p><input name="repassword" id="J_repassword" class="gray_text" type="password"></p>
                                </div>
                            </form>
