...
<div class="main_wrap">
    ...
    <dl>
        ...
        <div class="mess_box fl">
            <h3 class="title"><i><?php echo L('system_notic');?></i></h3>
            <?php if($system_list != ''): ?><ul class="system">
                <?php if(is_array($system_list)): $i = 0; $__LIST__ = $system_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><li>
                    <p class="sys_text clr6 fl"><?php echo ($val["info"]); ?></p>
                    <span class="sys_time fr"><?php echo (fdate($val["add_time"])); ?></span>
                </li><?php endforeach; endif; else: echo "" ;endif; ?>
            </ul>
            <div class="page_bar"><?php echo ($page_bar); ?></div>
            <?php else: ?>
            <p class="mt20"><?php echo L('no_system_notic');?></p><?php endif; ?>
        </div>
    </div>
</div>
<!-- unity footer -->
